...
[#453]: https://github.com/savvy-web/silk-release-action/pull/453

## 5.5.7

### Bug Fixes

- A re-run of the publishing phase now recovers an existing GitHub release only when GitHub reports it as a duplicate. Other release-creation failures are reported as-is instead of triggering a lookup by tag. [#450][#450]
...
[#450]: https://github.com/savvy-web/silk-release-action/pull/450
...
[#440]: https://github.com/savvy-web/silk-release-action/pull/440
...
[#437]: https://github.com/savvy-web/silk-release-action/pull/437
...
[#430]: https://github.com/savvy-web/silk-release-action/pull/430

## 5.5.1

### Bug Fixes

- Every `npm pack` and `npm publish` the action runs now goes through `pnpm dlx npm@12` instead of `npm@11`, on a kit that decodes both the npm 11 and npm 12 `pack --json` shapes. npm 12.0.0 changed `pack --json` from an array to an object keyed by package name; with `@effected/npm@0.14.1` that made every publish fail with `PublishError kind:"output"` even though the tarball was written, and would have hit the moment a runner's npm moved to 12 ([#424][#424]). npm 12.0.2 also restores the bundled `sigstore` that 12.0.0 shipped without, so the other reason for holding at 11 is gone.
...
- Added a suite that drives the real `PackagePublish` service with the pinned executor over `pack --json` output recorded from the actual npm 11.19.1 and 12.0.2 binaries, so the pin and the installed `@effected/npm` are proven to decode each other without a network fetch in CI [#425][#425]
...
[#424]: https://github.com/savvy-web/silk-release-action/issues/424

[#425]: https://github.com/savvy-web/silk-release-action/pull/425
...
[#416]: https://github.com/savvy-web/silk-release-action/pull/416
...
[#413]: https://github.com/savvy-web/silk-release-action/pull/413
...
[#410]: https://github.com/savvy-web/silk-release-action/pull/410
...
[#407]: https://github.com/savvy-web/silk-release-action/pull/407
...
[#404]: https://github.com/savvy-web/silk-release-action/pull/404
...
[#400]: https://github.com/savvy-web/silk-release-action/pull/400
...
[#395]: https://github.com/savvy-web/silk-release-action/pull/395
...
- `__test__/schemastore-config.test.ts` is removed: `pnpm schema:check` (run before vitest by `ci:test`) owns document drift, frozen-file identity and the ajv gate, and the identity-to-config agreement holds by construction [#391][#391]
...
[#391]: https://github.com/savvy-web/silk-release-action/pull/391
...
- `__test__/schemastore-config.test.ts` replaces the drift test: content drift is the CLI's job, the test pins `SCHEMA_URL`/`INPUT_SCHEMA_URL` to the config-derived `$id`s. [#389][#389]
...
[#389]: https://github.com/savvy-web/silk-release-action/pull/389
...
[#386]: https://github.com/savvy-web/silk-release-action/pull/386
...
[#383]: https://github.com/savvy-web/silk-release-action/pull/383
...
[#379]: https://github.com/savvy-web/silk-release-action/pull/379
...
- The vendored `.repos/effect` reference is repinned to `effect@4.0.0-rc.115` [#375][#375]

### Thanks

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#375]: https://github.com/savvy-web/silk-release-action/pull/375
...
[#371]: https://github.com/savvy-web/silk-release-action/pull/371
...
- The two config-dependency bumps move the catalog: `effect` `4.0.0-rc.109` to `4.0.0-rc.112`, `@savvy-web/silk-effects` to `7.5.1`, `@effected/workspaces` to `0.20.1` and `@effected/schemastore` to `0.6.0`. [#363][#363]

### Thanks

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#363]: https://github.com/savvy-web/silk-release-action/pull/363
...
- Removed a duplicate, empty `src/types/global.d.ts` left over alongside the root `types/global.d.ts`. [#361][#361]

### Thanks

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#361]: https://github.com/savvy-web/silk-release-action/pull/361
...
[#355]: https://github.com/savvy-web/silk-release-action/pull/355
...
[#352]: https://github.com/savvy-web/silk-release-action/pull/352
...
[#349]: https://github.com/savvy-web/silk-release-action/pull/349
...
[#342]: https://github.com/savvy-web/silk-release-action/pull/342
...
[#339]: https://github.com/savvy-web/silk-release-action/pull/339
...
[#336]: https://github.com/savvy-web/silk-release-action/pull/336
...
[#333]: https://github.com/savvy-web/silk-release-action/pull/333
...
[#320]: https://github.com/savvy-web/silk-release-action/pull/320
...
[#313]: https://github.com/savvy-web/silk-release-action/pull/313
...
[#310]: https://github.com/savvy-web/silk-release-action/pull/310
...
[#306]: https://github.com/savvy-web/silk-release-action/pull/306
...
- `__test__/registry-label.test.ts` now targets `@effected/npm` and serves as an adoption guard against upstream string drift. [#302][#302]
...
| @vitest-agent/plugin | devDependency | updated | ^2.4.6 | ^2.4.7 |
...
[#302]: https://github.com/savvy-web/silk-release-action/pull/302
...
- Adopts the Silk changesets wave. `@savvy-web/silk-effects` moves to a `^7.1.0`
  ...
  | @savvy-web/silk-effects | dependency | updated | ^7.0.1 | ^7.1.0 | [#297][#297] Thanks [@spencerbeggs](https://github.com/spencerbeggs)! |

### Patch Changes

[#297]: https://github.com/savvy-web/silk-release-action/pull/297
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @savvy-web/silk-effects | dependency | updated | ^7.0.0 | ^7.0.1 | [#295][#295] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#295]: https://github.com/savvy-web/silk-release-action/pull/295
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @savvy-web/silk-effects | dependency | updated | ^5.9.3 | ^7.0.0 | [#289][#289] Thanks [@spencerbeggs](https://github.com/spencerbeggs)! |

### Patch Changes

[#289]: https://github.com/savvy-web/silk-release-action/pull/289
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/workspaces | dependency | updated | ^0.17.0 | ^0.17.1 | [#287][#287] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#287]: https://github.com/savvy-web/silk-release-action/pull/287
...
- | Dependency | Type | Action | From | To |  |
  | --- | --- | --- | --- | --- | --- |
  | @effected/workspaces | dependency | updated | ^0.16.0 | ^0.17.0 | [#278][#278] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#278]: https://github.com/savvy-web/silk-release-action/pull/278
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @effected/workspaces | dependency | updated | ^0.15.1 | ^0.16.0 | [#273][#273] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#273]: https://github.com/savvy-web/silk-release-action/pull/273
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @effected/workspaces | dependency | updated | ^0.14.2 | ^0.15.1 | [#270][#270] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#270]: https://github.com/savvy-web/silk-release-action/pull/270
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @savvy-web/silk-effects | dependency | updated | ^5.8.1 | ^5.9.0 | [#250][#250] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |
...
- ### The characterization tests for this path now assert the fix
  ...
  **The remaining Phase-2 degradation paths are still live** and still pinned: a crashed issue-linking step, a check run that could not be created, a failed comment write, and a failed pull-request lookup. `CLAUDE.md` and the design docs now say which path is fixed and which are not, rather than describing the whole family as an open defect. [#250][#250]

### Patch Changes

Thanks to [@savvy-web-bot](https://github.com/apps/savvy-web-bot) for their contributions!

[#216]: https://github.com/savvy-web/silk-release-action/issues/216

[#250]: https://github.com/savvy-web/silk-release-action/pull/250
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @savvy-web/silk-effects | dependency | updated | ^5.7.0 | ^5.7.1 | [#232][#232] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#232]: https://github.com/savvy-web/silk-release-action/pull/232
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @effected/github-actions | dependency | updated | ^0.6.0 | ^0.6.1 | [#229][#229] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#229]: https://github.com/savvy-web/silk-release-action/pull/229
...
- | Dependency | Type | Action | From | To |  |
  ...
  | @savvy-web/silk-effects | dependency | updated | ^5.6.0 | ^5.7.0 | [#226][#226] Thanks [@savvy-web-bot](https://github.com/apps/savvy-web-bot)! |

### Patch Changes

[#226]: https://github.com/savvy-web/silk-release-action/pull/226
