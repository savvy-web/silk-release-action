export const __rspack_esm_id = 291;
export const __rspack_esm_ids = [291];
...
19630(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
 ...
 */ async function preValidateAllTargets(packageTargetsMap, packageManager) {
    ...
    if (success) {
        ...
        for (const errorItem of errorTargets){
            const registryName = (0,resolve_targets/* .getRegistryDisplayName */.DN)(errorItem.target.registry);
 ...
 */ function toPreValidationDetails(result) {
    const convert = (v)=>({
            registryName: (0,resolve_targets/* .getRegistryDisplayName */.DN)(v.target.registry),
